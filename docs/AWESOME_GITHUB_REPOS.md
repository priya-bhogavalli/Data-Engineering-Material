# 🌟 Awesome GitHub Repositories for Data Engineering

## 📋 Table of Contents

1. [Core Data Engineering](#core-data-engineering)
...
- [**awesome-data-engineering**](https://github.com/igorbarinov/awesome-data-engineering) - Comprehensive list of data engineering tools and frameworks
- [**data-engineering-zoomcamp**](https://github.com/DataTalksClub/data-engineering-zoomcamp) - Free data engineering course with hands-on projects
- [**awesome-pipeline**](https://github.com/pditommaso/awesome-pipeline) - Curated list of pipeline toolkits
- [**data-engineering-practice**](https://github.com/danielbeach/data-engineering-practice) - Real-world data engineering practice problems
...
### Python
- [**awesome-python**](https://github.com/vinta/awesome-python) - Curated list of awesome Python frameworks, libraries, software
...
- [**sql-style-guide**](https://github.com/mattm/sql-style-guide) - SQL style guide for readable queries
- [**sqlfluff**](https://github.com/sqlfluff/sqlfluff) - SQL linter and auto-formatter

### Data Structures & Algorithms
- [**awesome-algorithms**](https://github.com/tayllan/awesome-algorithms) - Curated list of awesome places to learn and/or practice algorithms
...
### AWS
- [**awesome-aws**](https://github.com/donnemartin/awesome-aws) - Curated list of awesome Amazon Web Services libraries, tools, and resources
- [**aws-samples**](https://github.com/aws-samples) - Official AWS code samples and examples
- [**localstack**](https://github.com/localstack/localstack) - Fully functional local AWS cloud stack
- [**aws-cli**](https://github.com/aws/aws-cli) - Universal command line interface for Amazon Web Services
- [**boto3**](https://github.com/boto/boto3) - AWS SDK for Python

### Azure
- [**awesome-azure**](https://github.com/kristofferandreasen/awesome-azure) - Awesome list of Azure resources
- [**azure-cli**](https://github.com/Azure/azure-cli) - Azure command-line interface
- [**azure-sdk-for-python**](https://github.com/Azure/azure-sdk-for-python) - Azure SDK for Python

### GCP
- [**awesome-gcp**](https://github.com/GoogleCloudPlatform/awesome-google-cloud) - Curated list of awesome Google Cloud Platform resources
...
- [**pulumi**](https://github.com/pulumi/pulumi) - Modern infrastructure as code platform
...
- [**awesome-database**](https://github.com/numetriclabz/awesome-db) - Curated list of amazingly awesome database libraries, resources and shiny things
- [**awesome-database-learning**](https://github.com/pingcap/awesome-database-learning) - Database learning materials

### SQL Databases
- [**awesome-postgres**](https://github.com/dhamaniasad/awesome-postgres) - Curated list of awesome PostgreSQL software, libraries, tools
- [**awesome-mysql**](https://github.com/shlomi-noach/awesome-mysql) - Curated list of awesome MySQL free and opensource software

### NoSQL Databases
- [**awesome-mongodb**](https://github.com/ramnes/awesome-mongodb) - Curated list of awesome MongoDB resources
- [**awesome-redis**](https://github.com/JamzyWang/awesome-redis) - Curated list of awesome Redis libraries & tools
- [**awesome-cassandra**](https://github.com/Anant/awesome-cassandra) - Curated list of awesome Cassandra resources
- [**awesome-elasticsearch**](https://github.com/dzharii/awesome-elasticsearch) - Curated list of useful Elasticsearch resources
...
### Apache Spark
- [**awesome-spark**](https://github.com/awesome-spark/awesome-spark) - Curated list of awesome Apache Spark packages and resources
- [**spark-examples**](https://github.com/spark-examples/pyspark-examples) - PySpark examples and tutorials

### Streaming
- [**awesome-kafka**](https://github.com/infoslack/awesome-kafka) - Everything about Apache Kafka
- [**awesome-streaming**](https://github.com/manuzhang/awesome-streaming) - Curated list of awesome streaming frameworks, applications, etc

### Data Processing
- [**awesome-bigdata**](https://github.com/0xnr/awesome-bigdata) - Curated list of awesome big data frameworks, resources and other awesomeness
- [**awesome-hadoop**](https://github.com/youngwookim/awesome-hadoop) - Curated list of amazingly awesome Hadoop and Hadoop ecosystem resources
...
- [**awesome-kubernetes**](https://github.com/ramitsurana/awesome-kubernetes) - Curated list for awesome kubernetes sources

### CI/CD
- [**awesome-ci**](https://github.com/ligurio/awesome-ci) - List of Continuous Integration services
- [**awesome-jenkins**](https://github.com/sahilsk/awesome-jenkins) - Curated list of awesome Jenkins plugins, links and resources

### Infrastructure as Code
- [**awesome-terraform**](https://github.com/shuaibiyy/awesome-terraform) - Curated list of resources on HashiCorp's Terraform
- [**awesome-ansible**](https://github.com/KeyboardInterrupt/awesome-ansible) - Curated list of awesome Ansible resources
...
### General ML
- [**awesome-machine-learning**](https://github.com/josephmisiti/awesome-machine-learning) - Curated list of awesome Machine Learning frameworks, libraries and software
- [**awesome-mlops**](https://github.com/visenger/awesome-mlops) - Curated list of awesome MLOps tools
- [**ml-engineering**](https://github.com/stas00/ml-engineering) - Machine Learning Engineering guides and tools

### Deep Learning
- [**awesome-deep-learning**](https://github.com/ChristosChristofidis/awesome-deep-learning) - Curated list of awesome Deep Learning tutorials, projects and communities

### Data Science
- [**awesome-datascience**](https://github.com/academic/awesome-datascience) - Curated list of awesome data science resources
- [**data-science-ipython-notebooks**](https://github.com/donnemartin/data-science-ipython-notebooks) - Data science Python notebooks
...
- [**awesome-system-design**](https://github.com/madd86/awesome-system-design) - Curated list of awesome System Design resources
- [**system-design-interview**](https://github.com/checkcheckzz/system-design-interview) - System design interview questions and answers
...
- [**apache/flink**](https://github.com/apache/flink) - Apache Flink with extensive examples
- [**uber/AthenaX**](https://github.com/uber/AthenaX) - Streaming analytics platform that enables users to run production-quality SQL
- [**linkedin/brooklin**](https://github.com/linkedin/brooklin) - Distributed system for streaming data between various heterogeneous source and destination systems

### Data Lake Implementations
- [**delta-io/delta**](https://github.com/delta-io/delta) - Open-source storage framework that enables building a Lakehouse architecture
- [**apache/iceberg**](https://github.com/apache/iceberg) - High-performance format for huge analytic tables
- [**apache/hudi**](https://github.com/apache/hudi) - Upserts, Deletes And Incremental Processing On Big Data
- [**trinodb/trino**](https://github.com/trinodb/trino) - Fast distributed SQL query engine for big data analytics

### Microservices Data Patterns
- [**eventuate-tram/eventuate-tram-core**](https://github.com/eventuate-tram/eventuate-tram-core) - Distributed data management patterns
- [**microsoft/reverse-proxy**](https://github.com/microsoft/reverse-proxy) - Toolkit for developing high-performance HTTP reverse proxy applications
- [**Netflix/conductor**](https://github.com/Netflix/conductor) - Conductor is a microservices orchestration engine

### Data Quality & Testing Examples
- [**great-expectations/great_expectations**](https://github.com/great-expectations/great_expectations) - Production data validation framework
- [**monte-carlo-data/soda-core**](https://github.com/sodadata/soda-core) - Data quality testing framework
- [**whylabs/whylogs**](https://github.com/whylabs/whylogs) - Data logging library for ML monitoring

### Infrastructure as Code Examples
- [**terraform-aws-modules**](https://github.com/terraform-aws-modules) - Collection of Terraform AWS modules
- [**pulumi/examples**](https://github.com/pulumi/examples) - Infrastructure, containers, and serverless apps to AWS, Azure, GCP, and Kubernetes
- [**hashicorp/terraform-provider-aws**](https://github.com/hashicorp/terraform-provider-aws) - Terraform AWS provider with extensive examples

### Monitoring & Observability Examples
- [**prometheus/prometheus**](https://github.com/prometheus/prometheus) - Monitoring system with real-world configurations
- [**grafana/grafana**](https://github.com/grafana/grafana) - Observability platform with dashboard examples
- [**jaegertracing/jaeger**](https://github.com/jaegertracing/jaeger) - Distributed tracing platform
- [**elastic/beats**](https://github.com/elastic/beats) - Lightweight shippers for Elasticsearch & Logstash

### API & Data Service Examples
- [**fastapi/fastapi**](https://github.com/tiangolo/fastapi) - Modern, fast web framework for building APIs with Python
- [**graphql/graphql-spec**](https://github.com/graphql/graphql-spec) - GraphQL specification with reference implementations
- [**apache/arrow**](https://github.com/apache/arrow) - Columnar in-memory analytics layer

### Security & Compliance Examples
- [**Netflix/security_monkey**](https://github.com/Netflix/security_monkey) - Security tool that monitors AWS, GCP, OpenStack, and GitHub orgs
- [**bridgecrewio/checkov**](https://github.com/bridgecrewio/checkov) - Static code analysis tool for infrastructure as code
- [**aquasecurity/trivy**](https://github.com/aquasecurity/trivy) - Scanner for vulnerabilities in container images
...
Remember to ⭐ star the repositories you find useful and consider contributing back to the open-source community!