...
3. [Reference Architectures](#️-reference-architectures)
...
9. [Security Architecture](#️-security-architecture)
...
12. [Architecture Decision Framework](#-architecture-decision-framework)
    ...
    - [Architecture Review Checklist](#2-architecture-review-checklist)
