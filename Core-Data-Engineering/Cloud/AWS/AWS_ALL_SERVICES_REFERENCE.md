...
| Service Name | Category | Description | Primary Use Cases | Documentation Link |
|--------------|----------|-------------|-------------------|-------------------|
| **Amazon EC2** | Compute | Resizable virtual servers providing secure, scalable compute capacity in the cloud with various instance types optimized for different workloads | Web applications, data processing, development environments, high-performance computing, enterprise applications | [docs.aws.amazon.com/ec2](https://docs.aws.amazon.com/ec2/) |
| **AWS Lambda** | Compute | Event-driven serverless compute service that runs code without provisioning servers, automatically scaling and charging only for compute time used | Real-time file processing, stream processing, API backends, ETL operations, IoT backends, chatbots | [docs.aws.amazon.com/lambda](https://docs.aws.amazon.com/lambda/) |
| **Amazon ECS** | Compute | Fully managed container orchestration service that makes it easy to deploy, manage, and scale containerized applications using Docker | Microservices architectures, batch processing, machine learning applications, web applications | [docs.aws.amazon.com/ecs](https://docs.aws.amazon.com/ecs/) |
| **Amazon EKS** | Compute | Fully managed Kubernetes service that runs upstream Kubernetes and is certified Kubernetes conformant for predictable behavior | Cloud-native applications, microservices, CI/CD pipelines, machine learning workloads, hybrid deployments | [docs.aws.amazon.com/eks](https://docs.aws.amazon.com/eks/) |
| **AWS Fargate** | Compute | Serverless compute engine for containers that removes the need to provision and manage servers, letting you focus on applications | Containerized applications without infrastructure management, microservices, batch jobs, web applications | [docs.aws.amazon.com/fargate](https://docs.aws.amazon.com/fargate/) |
| **AWS Batch** | Compute | Fully managed service for running batch computing workloads at any scale, dynamically provisioning optimal compute resources | Scientific computing, financial risk modeling, drug discovery, image processing, genomics analysis | [docs.aws.amazon.com/batch](https://docs.aws.amazon.com/batch/) |
| **Amazon Lightsail** | Compute | Easy-to-use virtual private server instances, containers, storage, databases, and networking with predictable pricing | Simple web applications, development environments, small business websites, e-commerce sites | [docs.aws.amazon.com/lightsail](https://docs.aws.amazon.com/lightsail/) |
| **AWS Outposts** | Compute | Fully managed service that extends AWS infrastructure, services, APIs, and tools to on-premises facilities for hybrid cloud architecture | Low-latency applications, local data processing, data residency requirements, hybrid cloud workloads | [docs.aws.amazon.com/outposts](https://docs.aws.amazon.com/outposts/) |
| **AWS Wavelength** | Compute | Infrastructure deployments that embed AWS compute and storage services at 5G network edge to minimize latency for mobile applications | Augmented/virtual reality, autonomous vehicles, IoT applications, real-time gaming, live video streaming | [docs.aws.amazon.com/wavelength](https://docs.aws.amazon.com/wavelength/) |
| **AWS Local Zones** | Compute | Infrastructure deployments that place compute, storage, database, and other AWS services closer to end-users for ultra-low latency | Real-time gaming, live streaming, augmented reality, machine learning inference at the edge | [docs.aws.amazon.com/local-zones](https://docs.aws.amazon.com/local-zones/) |
