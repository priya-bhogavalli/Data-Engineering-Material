...
|-----------|----------|-----------|----------|----------|
| **Coordination** | Leader Node | Services Layer | Dremel | Control Node |
| **Compute** | Compute Nodes | Virtual Warehouses | Slots | Compute Nodes |
| **Storage** | Local/Managed | Cloud Object Store | Colossus | Premium/Standard |
...
├─────────────────┼──────────────┼──────────────┼──────────────┤
│ Leader Node     │ High         │ Low          │ Single Point │
│ Compute Nodes   │ Very High    │ Medium       │ Linear       │
│ Node Slices     │ Excellent    │ Low          │ Fixed        │
│ Columnar Store  │ High         │ Medium       │ Excellent    │
│ MPP Processing  │ Excellent    │ Medium       │ Linear       │
└─────────────────┴──────────────┴──────────────┴──────────────┘
```
...
|-----------|----------|---------|--------|-------|------------|----------|
| **ra3.xlplus** | Balanced workloads | Managed Storage | 32 GB | 4 | $3.26 | Growing datasets |
| **ra3.4xlarge** | Heavy workloads | Managed Storage | 96 GB | 12 | $9.78 | Large analytics |
...
#### **Performance Characteristics**
```
Node Type Performance Comparison (TPC-DS 1TB):
┌─────────────────┬──────────────┬──────────────┬──────────────┐
│ Node Type       │ Query Time   │ Throughput   │ Cost/Query   │
├─────────────────┼──────────────┼──────────────┼──────────────┤
│ dc2.large       │ 180 sec      │ Low          │ $0.12        │
│ dc2.8xlarge     │ 45 sec       │ High         │ $0.36        │
│ ra3.xlplus      │ 120 sec      │ Medium       │ $0.65        │
│ ra3.4xlarge     │ 60 sec       │ High         │ $0.98        │
