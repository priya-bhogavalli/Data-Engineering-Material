...
1. [Data Definition Language (DDL)](#1-data-definition-language-ddl)
   ...
   - [DROP and TRUNCATE](#3-joins-and-relationships)
...
3. [Joins and Relationships](#3-joins-and-relationships)
   ...
   - [OUTER JOINS](#3-joins-and-relationships)
   - [SELF JOIN](#self-join)
4. [Window Functions](#4-window-functions)
   - [Ranking Functions](#4-window-functions)
   - [Aggregate Window Functions](#4-window-functions)
   - [Lead and Lag Functions](#8-data-types-and-functions)
...
6. [Aggregation and Grouping](#6-aggregation-and-grouping)
   - [Basic Aggregation](#6-aggregation-and-grouping)
   - [GROUP BY with HAVING](#group-by-with-having)
   - [Advanced Grouping](#6-aggregation-and-grouping)
7. [Subqueries and Correlated Queries](#7-subqueries-and-correlated-queries)
   - [Scalar Subqueries](#7-subqueries-and-correlated-queries)
   - [EXISTS and NOT EXISTS](#3-joins-and-relationships)
   - [Correlated Subqueries](#7-subqueries-and-correlated-queries)
8. [Data Types and Functions](#8-data-types-and-functions)
   - [String Functions](#4-window-functions)
   - [Date and Time Functions](#8-data-types-and-functions)
   - [Numeric Functions](#4-window-functions)
9. [Performance Optimization](#9-performance-optimization)
   - [Index Strategies](#index-strategies)
   - [Query Optimization Techniques](#9-performance-optimization)
10. [Data Quality and Constraints](#10-data-quality-and-constraints)
    - [Constraint Types](#8-data-types-and-functions)
    - [Data Validation Queries](#sql-key-concepts-for-data-engineering)
