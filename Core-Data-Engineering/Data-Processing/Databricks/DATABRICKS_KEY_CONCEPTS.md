...
2. [Clusters](#2-clusters)
   ...
   - [Cluster Optimization](#memory-optimization)
3. [Delta Lake](#delta-lake-optimizations)
   - [Creating Delta Tables](#delta-lake-optimizations)
   - [Delta Operations](#delta-lake-optimizations)
   - [Time Travel](#time-travel)
4. [Notebooks](#4-notebooks)
   - [Notebook Features](#notebook-features)
   - [Collaboration Features](#collaboration-features)
5. [Jobs and Workflows](#5-jobs-and-workflows)
   - [Job Configuration](#job-clusters)
   - [Multi-task Jobs](#5-jobs-and-workflows)
...
7. [Streaming](#7-streaming)
   - [Structured Streaming with Delta Lake](#delta-lake-optimizations)
   - [Stream-Stream Joins](#stream-stream-joins)
8. [Unity Catalog](#8-unity-catalog)
   - [Three-Level Namespace](#three-level-namespace)
   - [Creating Catalogs and Schemas](#interactive-development-and-exploration)
   - [Access Control](#version-control-integration)
9. [Performance Optimization](#9-performance-optimization)
   - [Partitioning](#multi-level-partitioning)
   - [Z-Ordering](#z-ordering)
   - [Caching](#caching)
   - [Broadcast Joins](#broadcast-small-dimension-tables)
10. [MLflow Integration](#10-mlflow-integration)
    - [Experiment Tracking](#experiment-tracking)
    - [Model Registry](#train-model)
