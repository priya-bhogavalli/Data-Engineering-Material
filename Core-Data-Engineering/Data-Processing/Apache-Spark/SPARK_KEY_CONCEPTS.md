...
1. [RDD (Resilient Distributed Dataset)](#1-rdd-resilient-distributed-dataset)
   - [Key Properties](#apache-spark-key-concepts)
   - [Creating RDDs](#example-4-creating-derived-datasets)
   - [RDD Operations](#1-rdd-resilient-distributed-dataset)
2. [DataFrame and Dataset](#2-dataframe-and-dataset)
   - [DataFrame Advantages](#2-dataframe-and-dataset)
   - [Creating DataFrames](#example-4-creating-derived-datasets)
   - [DataFrame Operations](#2-dataframe-and-dataset)
3. [Transformations vs Actions](#3-transformations-vs-actions)
   - [Transformations (Lazy)](#3-transformations-vs-actions)
   - [Actions (Eager)](#3-transformations-vs-actions)
   - [Why Lazy Evaluation](#this-is-why-data-engineers-prefer-parquet-for-large-datasets)
4. [Partitioning](#4-partitioning)
   - [Default Partitioning](#default-partitioning-rules)
   - [Manual Partitioning](#4-partitioning)
   - [Custom Partitioning](#4-partitioning)
5. [Caching and Persistence](#5-caching-and-persistence)
   - [When to Cache](#a-retail-company-wants-to-analyze-5-years-of-sales-data-500gb)
   - [Storage Levels](#cache-with-custom-storage-level)
   - [Cache Management](#solution-cache-intermediate-results-see-caching-section)
6. [Spark SQL](#6-spark-sql)
   - [SQL Interface](#example-5-using-sql-on-dataframes-familiar-to-analysts)
   - [Built-in Functions](#string-functions)
7. [Joins](#7-joins)
   - [Join Types](#result-dataframe-with-proper-column-names-and-types)
   - [Join Optimization](#inner-join-default)
...
9. [Configuration and Tuning](#9-configuration-and-tuning)
   - [Memory Configuration](#instead-of-loading-1tb-into-one-machines-memory-impossible)
   - [Performance Tuning](#9-configuration-and-tuning)
10. [Structured Streaming](#10-structured-streaming)
    - [Basic Streaming](#10-structured-streaming)
    - [Windowed Aggregations](#windowed-aggregations)
11. [Error Handling and Debugging](#11-error-handling-and-debugging)
    - [Exception Handling](#spark-splits-it-across-100-machines-each-handling-10gb)
    - [Debugging Techniques](#11-error-handling-and-debugging)
12. [Best Practices](#12-best-practices)
    - [Data Processing](#example-3-processing-e-commerce-transaction-data)
